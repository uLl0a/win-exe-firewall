...
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; $tmp = "$env:TEMP\BloquearEXEs.ps1"; irm "https://raw.githubusercontent.com/uLl0a/win-exe-firewall/refs/heads/main/BloquearEXEs.ps1" -OutFile $tmp; . $tmp; Remove-Item $tmp -ErrorAction SilentlyContinue
